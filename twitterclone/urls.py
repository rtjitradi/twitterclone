...
urlpatterns = [
    ...
    path('logout/', authenticationviews.LogoutView.as_view(), name='logout'),
    path('addtweet/', tweetviews.AddTweetView.as_view(), name='addtweet'),
    path('tweetdetails/<int:tweet_id>/', twitteruserviews.PostTweetView.as_view(), name='tweetdetails'),
    path('userprofile/<str:user_username>/', twitteruserviews.UserProfileView.as_view(), name='userprofile'),
    path('notifications/<str:user_username>/', twitteruserviews.notifications_view, name='notifications'),
    # path('notifications/<str:user_username>/', twitteruserviews.NotificationsView.as_view(), name='notifications'),
    # path('follow/<str:user_username>/', twitteruserviews.follow_view, name='follow'),
    path('follow/<str:user_username>/', twitteruserviews.FollowView.as_view(), name='follow'),
    # path('unfollow/<str:user_username>/', twitteruserviews.unfollow_view, name='unfollow'),
    path('unfollow/<str:user_username>/', twitteruserviews.UnfollowView.as_view(), name='unfollow'),
